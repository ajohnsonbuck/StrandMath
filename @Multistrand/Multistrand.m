    ...
    methods
        ...
        function a = findLongestDuplex(a) % Find duplex with largest number of base pairs
            ...
            for m = 1:numel(objArray)
                ...
                % schema(2,objArray(m).Strands{1}.len:objArray(m).Strands{1}.len+objArray(m).Strands{2}.len-1) = objArray(m).Strands{2}.reverse.bareSequence; % Reverse of bare version of first sequence
