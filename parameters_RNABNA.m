function [dH0, dS0, dG] = parameters_RNABNA(rseq,T)
    ...
    dS0 = dS0+4.9*length(rseq);  % Assume dS0 decreases by 3.33 for each BNA modification -- based on estimate that deltaG drops by ~1000 cal/mol for each increase in ~6 deg C to the melting temp
